                ...
                <div class="col-md-8">
                    <div class="panel panel-primary">
                        <div class="panel-body">
                            ...
                            <div class="inner-addon right-addon">
                                <i class="glyphicon">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Falta a Data de Nascimento." ControlToValidate="txtDataNasc" Font-Bold="True" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                                ...
                                <asp:TextBox ID="txtDataNasc" runat="server" CssClass="form-control" AutoCompleteType="Disabled" placeholder="Data de Nascimento (AAAA-MM-DD)" MaxLength="50"></asp:TextBox>
                            </div>
                            <br />
